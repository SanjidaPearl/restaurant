const DISHES = [
    ...
    },
    {
        id: 4,
        name: 'Biriyani',
        image: 'assets/images/4biriyani.jpg',
        category: 'meal',
            label: 'Hot',
            price: '250',
            featured: true,
            description: 'A flavorful and aromatic rice dish cooked with spices and meat, popular in South Asia',
    },
    {
        id: 5,
        name: 'Milkshake',
        image: 'assets/images/5milkshake.jpg',
        category: 'beverage', 
        label: 'Refreshing', 
        price: '150', 
        featured: true,
        description: 'A creamy and refreshing beverage made with milk, ice cream, and various flavorings' 
    }
